...
func (self *BaseController) Prepare() {
	...
	//if self.controllerName != "login" && self.actionName != "no_auth" {
	//	//self.redirect(beego.URLFor("LoginController.NoAuth"))
...
func (self *BaseController) AdminAuth() string  {
	// 左侧导航栏
